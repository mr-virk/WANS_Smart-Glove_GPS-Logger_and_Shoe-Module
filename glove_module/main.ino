...
#define button1 3 // this button use for Alarm & Vibrator mode
#define button2 2 // this button use for only Vibrator mode
...
void loop() {
  ...
  if (digitalRead(button1) == 0) Alarm = 1, Vibrator = 1; //Alarm & Vibrator mode
  if (digitalRead(button2) == 0) Alarm = 0, Vibrator = 1; //only Vibrator mode
